  ...
  render() {
    ...
    return (
      <View style={[style, { overflow: 'hidden' }]}>
        ...
        {!!preview && Platform.OS === "ios" && <AnimatedBlurView style={[computedStyle, { backgroundColor: tint, opacity }]} {...{ intensity, tint }} />}
        {!!preview && Platform.OS === "android" && (
          <Animated.View style={[computedStyle, { backgroundColor: tint, opacity }]} />
        )}
      </View>
    );
  }
